<div class="container-fluid footer text-white mt-2 pt-2 px-0 position-relative" style="background-color: #021; background-image: url(''); background-size: cover;">
    <?php foreach ($profil as $footer) : ?>
        ...
        <div class="container-fluid text-center text-white border-top mt-2 py-4 px-sm-3 px-md-5">
            ...
            <hr style="border: 1px solid orange; width: 50%; margin: 20px auto;">
