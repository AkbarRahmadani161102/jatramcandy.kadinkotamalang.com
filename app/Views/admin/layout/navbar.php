<div id="app-sidepanel" class="app-sidepanel">
    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="<?= base_url('admin/dashboard') ?>"><img class="logo-icon me-2" src="<?= base_url('assets/images/app-logo.svg') ?>" alt="logo"><span class="logo-text">FoodFuds</span></a>
        </div><!--//app-branding-->
